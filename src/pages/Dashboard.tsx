...
const Dashboard = () => {
  ...
  const stats = [
    ...
    {
      title: 'Digitalizadas',
      value: partituras?.filter(p => p.digitalizado === true).length || 0,
      icon: TrendingUp,
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {quickActions.map((action, index) => (
              ...
              >
                ...
                <span className="text-sm text-left opacity-90">{action.description}</span>
              </Button>
            ))}
          </div>
        </CardContent>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle>Partituras Recentes</CardTitle>
            <CardDescription>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Performances Recentes</CardTitle>
            <CardDescription>
